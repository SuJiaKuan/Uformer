...
train_dataset = DefectsDataset(opt.train_dir, 4800, img_options=img_options_train)
train_loader = DataLoader(dataset=train_dataset, batch_size=opt.batch_size, shuffle=True, 
        num_workers=opt.train_workers, pin_memory=False, drop_last=False)
val_dataset = DefectsDataset(opt.train_dir, 1200, img_options=img_options_train)
